...
public class DoubleSetApp {
    ...
    public static void main(String[] args) {
        ...
        boolean exit = false;
        SetAbs<Double> mySet1;
        SetAbs<Double> mySet2;
        int choice;
        int selection;
        Double toAdd;
        Double toRemove;
        ...
        while (!exit) {
            ...
            if (selection != 5) {
                ...
                do {
                    ...
                    else if(mySet1.contains(Double.parseDouble(user))){
                        System.out.println("Value is already in the set");
                    }
                    else if(!mySet1.contains(Double.parseDouble(user))) {
                        toAdd = Double.parseDouble(user);
                        mySet1.add(toAdd);
                    }
                } while (keepAdding);
                ...
                do {
                    ...
                    else if(mySet2.contains(Double.parseDouble(user))){
                        System.out.println("Value is already in the set");
                    }
                    else {
                        toAdd = Double.parseDouble(user);
